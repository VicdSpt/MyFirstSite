...
const MyTimeline = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-8 sm:py-12 md:py-16 px-4 sm:px-6 flex items-center justify-center">
      <div className="max-w-7xl mx-auto w-full">
        {/* Header */}
        <div className="text-center mb-10 sm:mb-14 md:mb-20">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-3">My Professional Journey</h1>
          <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300">From {formatDate(timelineData[0].startDate)} to Today</p>
          <p className="text-sm sm:text-base text-gray-400 dark:text-gray-500 mt-3">👆 Swipe or drag to explore</p>
        </div>
                ...
                <div className="flex flex-col items-center min-w-48 sm:min-w-56 md:min-w-64">
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-xl dark:shadow-gray-900/50 transition-shadow duration-300 p-4 sm:p-5 md:p-6 w-44 sm:w-52 md:w-60 mb-5 sm:mb-7">
                    <div className="text-center">
                      <h3 className="text-sm sm:text-base md:text-lg font-bold text-gray-900 dark:text-white mb-2 sm:mb-3 leading-tight">{item.title}</h3>
                      <p className="text-xs sm:text-sm text-blue-600 dark:text-blue-400 font-medium mb-3 sm:mb-4">{item.company}</p>
                  ...
                  {/* Icon */}
                  <div className={`${getTypeColor(item.type)} rounded-full p-3 sm:p-4 text-white shadow-lg`}>
                    {getIcon(item.type)}
                  </div>
            ...
            <div className="flex items-center">
              ...
              <div className="flex flex-col items-center min-w-44 sm:min-w-52 md:min-w-60">
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 rounded-xl p-4 sm:p-5 md:p-6 border-2 border-blue-200 dark:border-blue-700 shadow-md dark:shadow-gray-900/50 w-44 sm:w-52 md:w-60 mb-5 sm:mb-7">
                  <h3 className="text-sm sm:text-base md:text-lg font-bold text-gray-900 dark:text-white text-center">Today</h3>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-8 mt-8 sm:mt-12 md:mt-16">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm sm:text-base md:text-lg text-gray-600 dark:text-gray-300">Work Experience</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-4 sm:w-5 h-4 sm:h-5 bg-purple-500 rounded-full"></div>
            <span className="text-sm sm:text-base md:text-lg text-gray-600 dark:text-gray-300">Education</span>
          </div>
        </div>
      </div>
    </div>
