...
function SectionFullStackBxl() {
  return (
    <section className="relative flex flex-col bg-amber-300">
      <div className="max-w-7xl mx-auto w-full px-6 pt-30 pb-20">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
          ...
          <div className="flex flex-col justify-center gap-4 lg:w-1/2">
            <h1 className="text-5xl font-bold">Victor de Spirlet</h1>
            <p className="text-xl font-semibold">Fullstack Engineer in Brussels</p>
            <p className="text-lg">Building fun stuff for people</p>
          </div>

          {/* Right side - Paragraphs */}
          <div className="flex flex-col gap-6 text-gray-700 leading-relaxed lg:w-1/2">
            <p>
